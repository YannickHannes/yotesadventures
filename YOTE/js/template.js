...
var introLand = document.getElementById("introLand");
...
menuButton.onclick = function(){
  if (localStorage.getItem("YourNewHighScore") < c) {
    geven();
  }
  function geven(){
  localStorage.setItem("YourNewHighScore", c);
  }
  highscore.innerHTML = localStorage.getItem("YourNewHighScore") - 5+'m';
  myGameArea.stop();
...
function startGame() {
    myGamePiece = new component(40, 55, "img/character-down.svg", 10, 120, "image");
    myBackground = new component(656, 270, "img/backgroundZero.svg", 0, 0, "background");
  ...
  for (i = 0; i < myObstacles.length; i += 1) {
      if (myGamePiece.crashWith(myObstacles[i])) {
        ...
        if (tel < 2000) {
          if (tel < 1500) {
            if ( myGameArea.frameNo == 1 || everyinterval(150)) {
              myObstacles.push(new component(30, 27, "img/obstacleZero.svg" , x, randomPosition1, "image"));
            }
            if ( myGameArea.frameNo == 2 || everyinterval(100)) {
              myObstacles.push(new component(30, 27, "img/obstacleZero.svg" , x, randomPosition2, "image"));
            }
          }
          if (everyinterval(15)) {
            for (var i = 0; i < myObstacles.length; i++) {
              myObstacles[i].image.src = "img/obstacleZeroMove.svg";
            }
          }
          if (everyinterval(30)) {
            for (var i = 0; i < myObstacles.length; i++) {
              myObstacles[i].image.src = "img/obstacleZero.svg";
            }
          }

        } else if (tel > 2000 && tel < 4500) {
          myBackground.image.src = "img/backgroundOne.svg";
          if (tel < 4000) {
            if ( myGameArea.frameNo == 1 || everyinterval(150)) {
                myObstacles.push(new component(20, height - 20, "img/obstacleOne.svg" , x, 0, "image"));
                myObstacles.push(new component(20,  x - height - gap, "img/obstacleOneMove.svg" , x, height + gap, "image"));
            }
          }
          if (everyinterval(15)) {
            for (var i = 0; i < myObstacles.length; i++) {
              myObstacles[i].image.src = "img/obstacleOne.svg";
            }
          }
          if (everyinterval(30)) {
            for (var i = 0; i < myObstacles.length; i++) {
              myObstacles[i].image.src = "img/obstacleOneMove.svg";
            }
          ...
          if ( myGameArea.frameNo == 2 || everyinterval(100)) {
            ...
            myBackground.image.src = "img/backgroundThree.svg";
            if ( myGameArea.frameNo == 1 || everyinterval(150)) {
            ...
            if ( myGameArea.frameNo == 2 || everyinterval(100)) {
              ...
              myBackground.image.src = "img/backgroundFour.svg";
              if ( myGameArea.frameNo == 1 || everyinterval(150)) {
                  ...
                  myBackground.image.src = "img/backgroundFive.svg";
              if ( myGameArea.frameNo == 1 || everyinterval(150)) {
                  myObstacles.push(new component(40, 25, "img/obstacleFive.png" , x, randomPosition1, "image"));
              }
              if ( myGameArea.frameNo == 2 || everyinterval(100)) {
                  myObstacles.push(new component(40, 25, "img/obstacleFive.png" , x, randomPosition2, "image"));
              }
        } else if (tel > 12500 && tel < 14000) {
                  myBackground.image.src = "img/backgroundSix.svg";
                if ( myGameArea.frameNo == 1 || everyinterval(150)) {
          ...
          if ( myGameArea.frameNo == 1 || everyinterval(150)) {
              myObstacles.push(new component(40, 25, "img/obstacleSeven.png" , x, randomPosition1, "image"));
          }
          if ( myGameArea.frameNo == 2 || everyinterval(100)) {
              myObstacles.push(new component(40, 25, "img/obstacleSeven.png" , x, randomPosition2, "image"));
          }
        } else if (tel > 16500 && tel < 2000000) {
                  myBackground.image.src = "img/backgroundEight.svg";
                  if ( myGameArea.frameNo == 1 || everyinterval(150)) {
                      myObstacles.push(new component(30, height - 20, "img/obstacleEightDown.png" , x, 0, "image"));
                      myObstacles.push(new component(30, x - height - gap, "img/obstacleEightUp.png" , x, height + gap, "image"));
                  }
        }
        // BACKGROUND IMAGES + OBSTACLES CHANGES
        ...
        function accelerate(n) {
          ...
          myGamePiece.image.src = "img/character-up.svg";
        }
...
butgo.ontouchend = function(){
    myGamePiece.image.src = "img/character-down.svg";
